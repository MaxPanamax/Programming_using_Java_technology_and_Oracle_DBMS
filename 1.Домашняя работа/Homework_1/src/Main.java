...
public class Main {
    ...
    public static void Menu(){
        ...
        try {
            System.out.print("Введите номер задания 1-12 если хотите выйти нажмите 0: ");
            ...
            switch (numberTask) {
                ...
                case 11 -> Task11();
                case 12 -> Task12();
                default -> System.out.println("!!!!!Будте внимательны, номер введен неверно!!!!!!");
            }
        } catch (Exception e) {
...
//        Steve Jobs
        public static void Task1(){
            System.out.println("Ваше время ограничено,");
            System.out.println("так что не тратьте его");
            System.out.println("впустую, живя чужой жизнью");
            System.out.println("Стив Джобс");
            Menu();
        }
        //Задание 2****************************************************
